...
const collectionId = "680718220012d8b2eb98"; // Brake collection ID
...
const ServiceDetailsPage: React.FC<ServiceDetailsPageProps> = ({ params }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching brake product:", err);
  ...
  const handleBookService = () => {
    ...
    // router.push(`/booking?serviceId=${productId}&type=brakes`);
  };
    ...
    return (
      <div className="min-h-screen bg-blue-50 py-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-blue-800">Loading brake service details...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc pl-6 text-blue-600 space-y-2">
                ...
                <li>Rotor inspection and resurfacing</li>
                <li>Brake fluid check and top-off</li>
            ...
            <div>
              ...
              <p className="text-blue-600 mb-4">Approximately 1 hour</p>
              <h3 className="text-lg font-semibold text-blue-700 mb-3">
                Warranty:
              </h3>
...
const RelatedProducts: React.FC<RelatedProductsProps> = ({
  ...
  useEffect(() => {
    const fetchRelatedProducts = async () => {
      try {
        ...
        console.error("Error fetching related brake products:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return (
    <div className="mt-16 text-center">
      ...
      <p className="mt-2 text-blue-600">Loading related brake products...</p>
    </div>
  );
  ...
  return (
    <div className="mt-16">
      <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">
        More Brake Services from {supplier}
      </h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex gap-2 mt-4">
                <button
                  onClick={() => router.push(`/services/brakes/${product.$id}`)}
...
// // // app/(root)/services/brakes/[id]/page.tsx
// // "use client";
...
// // import { PaymentProduct } from "@/hooks/useStripePayment";
...
// //   // Convert product to PaymentProduct format
// //   const getPaymentProduct = (product: ServiceProduct): PaymentProduct => ({
// //     id: product.$id,
// //     title: product.title,
// //     price: product.price,
// //     description: product.description,
...
// //             {/* Updated Buy Now Button with Stripe Integration */}
// //             <BuyNowButton
// //               product={getPaymentProduct(product)}
