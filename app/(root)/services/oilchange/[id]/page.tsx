...
// const OilChangeDetails: React.FC<OilChangeDetailsProps> = ({ params }) => {
...
//     // router.push(`/booking?serviceId=${productId}&type=oilChange`);
//   };
...
//           <p className="mt-4 text-blue-800">Loading oil change details...</p>
//         </div>
//       </div>
//     );
//   }
...
// interface RelatedOilProductsProps {
//   currentProductId: string;
//   supplier: string;
// }

// const RelatedOilProducts: React.FC<RelatedOilProductsProps> = ({
//   currentProductId,
//   supplier,
// }) => {
...
//       <p className="mt-2 text-blue-600">Loading related oil products...</p>
//     </div>
//   );
