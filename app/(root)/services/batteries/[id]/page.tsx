...
const collectionId = "6807175e00341dbc8fd5"; // Battery collection ID
...
const ServiceDetailsPage: React.FC<ServiceDetailsPageProps> = ({ params }) => {
  ...
  const handleBookService = () => {
    ...
    // router.push(`/booking?serviceId=${productId}&type=batteries`);
  };
    ...
    return (
      <div className="min-h-screen bg-blue-50 py-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-blue-800">Loading battery service details...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc pl-6 text-blue-600 space-y-2">
                ...
                <li>Terminal cleaning and inspection</li>
                <li>Charging system test</li>
                <li>Battery tray and hold-down check</li>
            ...
            <div>
              ...
              <p className="text-blue-600 mb-4">Approximately 30 minutes</p>
              <h3 className="text-lg font-semibold text-blue-700 mb-3">
                Warranty:
              </h3>
              <p className="text-blue-600">36 months / 36,000 miles</p>
            </div>
          </div>
        </div>
...
const RelatedProducts: React.FC<RelatedProductsProps> = ({
  ...
  if (loading) return (
    <div className="mt-16 text-center">
      ...
      <p className="mt-2 text-blue-600">Loading related battery products...</p>
    </div>
  );
  ...
  return (
    <div className="mt-16">
      <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">
        More Battery Services from {supplier}
      </h2>
...
// //   const getPaymentProduct = (product: BatteryProduct): PaymentProduct => ({
// //     id: product.$id,
// //     title: product.title,
// //     price: product.price,
// //     description: product.description,
