...
interface RelatedAirConditioningProductsProps {
...
const ServiceDetailsPage: React.FC<ServiceDetailsPageProps> = ({ params }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Error fetching air conditioning product:", err);
  ...
  const handleBookService = () => {
    ...
    // router.push(`/booking?serviceId=${productId}&type=airConditioning`);
  };
    ...
    return (
      <div className="min-h-screen bg-blue-50 py-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-blue-800">Loading air conditioning service details...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-blue-50 py-12 flex items-center justify-center">
        <div className="text-center bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-blue-800 mb-4">
            Air conditioning service not found
          </h2>
          <button
            onClick={() => router.push("/services/air")}
            className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
    ...
    <div className="min-h-screen bg-blue-50 py-12">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="list-disc pl-6 text-blue-600 space-y-2">
                ...
                <li>System pressure and leak testing</li>
                <li>Compressor and condenser inspection</li>
                <li>Cabin air filter check</li>
            ...
            <div>
              ...
              <p className="text-blue-600 mb-4">Approximately 45 minutes</p>
              <h3 className="text-lg font-semibold text-blue-700 mb-3">
                Warranty:
              </h3>
              <p className="text-blue-600">12 months / 12,000 miles</p>
            </div>
          </div>
        </div>
        ...
        {product.supplier && productId && (
          <RelatedAirConditioningProducts
...
const RelatedAirConditioningProducts: React.FC<RelatedAirConditioningProductsProps> = ({
  currentProductId,
  supplier,
}) => {
  ...
  useEffect(() => {
    const fetchRelatedProducts = async () => {
      try {
        ...
        console.error("Error fetching related air conditioning products:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return (
    <div className="mt-16 text-center">
      ...
      <p className="mt-2 text-blue-600">Loading related air conditioning products...</p>
    </div>
  );
  ...
  return (
    <div className="mt-16">
      <h2 className="text-3xl font-bold text-blue-800 mb-8 text-center">
        More Air Conditioning Services from {supplier}
      </h2>
